            ...
            <form class="form-horizontal" action="<?php echo base_url('item/update'); ?>" method="post">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong><?php echo $item->name; ?></strong></h3>
                    </div>
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control select" name="id_category">
                                                    <?php foreach($categories as $category): ?>
                                                        <option value="<?php echo $category->id; ?>" <?php set_select_value($item->id_category, $category->id); ?>><?php echo $category->name; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="buy_price" value="<?php echo $item->buy_price; ?>"/>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="sell_price" value="<?php echo $item->sell_price; ?>"/>
                                        </div>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control select" name="id_supplier">
                                            <?php foreach($suppliers as $supplier): ?>
                                                <option value="<?php echo $supplier->id; ?>" <?php set_select_value($item->id_supplier, $supplier->id); ?>><?php echo $supplier->name; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" name="weight" value="<?php echo $item->weight; ?>" placeholder="0.0"/>
                                            </div>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="weight_unit" value="<?php echo $item->weight_unit; ?>"/>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <label class="check"><input type="checkbox" class="icheckbox" checked="checked" name="is_available" <?php set_checkbox_value('is_available', 1); ?>/> Tersedia</label>
                                    </div>
                                </div>
                            </div>
                        </div>
